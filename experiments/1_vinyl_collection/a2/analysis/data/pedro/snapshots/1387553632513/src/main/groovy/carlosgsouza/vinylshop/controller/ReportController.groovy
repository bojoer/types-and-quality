...
public class ReportController {
	...
	public genre() {
		...
		result.data.put("Number of "+topItem+" vinyls", genre_vinylCount.get(genre).toString());
		result.data.put("Number of "+topItem+" songs", genre_songCount.get(genre).toString());

...
public class ReportController {
	...
	public Report genre() {
		...
		result.data.put("Number of "+topGenre+" vinyls", genre_vinylCount.get(stuff).toString());
		result.data.put("Number of "+topGenre+" songs", genre_songCount.get(stuff).toString());

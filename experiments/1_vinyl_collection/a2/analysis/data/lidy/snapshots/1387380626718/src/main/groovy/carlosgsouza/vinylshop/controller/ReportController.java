...
public class ReportController {;
	...
	public Report genre() {
		...
		result.data.put("Number of "+topItem+" vinyls", genre_vinylCount.get(topItem).toString());
		result.data.put("Number of "+topItem+" songs", genre_songCount.get(topItem).toString());

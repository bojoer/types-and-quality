...
public class ReportController {;
	...
	public Report artist() {
		...
		rsult.data.put("Number of artists", artistCount.toString());
		...
		rsult.data.put("Top artist", topArtist);
		rsult.data.put("Number of vinyls by "+topArtist, artist_vinylCount.get(topArtist).toString());
